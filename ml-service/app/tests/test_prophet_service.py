"""
Testes do prophet_service.

Estrutura simétrica ao test_holt_winters_service para permitir comparação
direta de comportamento entre os dois modelos.
...
from app.services.prophet_service import treinar_e_avaliar
...
class TestFallbackSerieCurta:
    ...
    def test_serie_curta_emite_aviso_de_sazonalidade(self, serie_curta, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="app.services.prophet_service"):
